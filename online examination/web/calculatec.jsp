...
<%
    ...
    String query1="select * from canswers  where email=? order by QNO";
    ...
    out.println("<br><br>"+"<b>Total questions="+(x+i+s)+"<br>Correct answers="+i+"<br>Wrong answers="+(s)+"<br>Unattempted="+x+"<br><br>");
        %>
